...
if __name__ == "__main__":
    ...
    print("\n Running CONTRAST + HYBRID + WEIGHTED LOSS experiment")

    # CONFIG
    CFG.experiment = "contrast_hybrid_weighted"
    CFG = update_cfg(CFG)
    ...
    print("\n CONTRAST + HYBRID + WEIGHTED LOSS experiment completed successfully")